...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            /*قائمة للاختيار منها هل الشخص شركة ام شخص يبحث عن العمل*/
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                ViewBag.UserType = new SelectList   
                    (db.Roles.Where(a=>!a.Name.Contains("Adminstrators")).ToList(), "Name", "Name" );
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, UserType = model.UserType /*لو عندي حقل اخر اكتب فصلة و اضيفه مثلا  , DateOfBirth = model.DateOfBirth*/};
        ...
        public ActionResult EditProfile(EditProfileViewModel profile)
        {
            ...
            {
                ViewBag.Message = " Current passwor is incorrect ";
            }
            else
            {
